...
<head>
  ...
  <style>
    ...
    #adminImage {
      background: url("https://codex-themes.com/scalia/zaro/wp-content/uploads/2014/12/header-background.jpg");
      padding: 2% 0%;
    }
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3 ">
        <nav aria-label="breadcrumb">
          <h4 class="font-weight-bolder mb-0">Add Wallet Details <i class="las la-wallet"></i></h4>
        </nav>
    ...
    <div id="walletForm">
      <form action="" method="post">
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Amount Pay for</label>
          <input type="number" class="form-control" name="updatedAmount"  id="exampleInputEmail1" aria-describedby="amountUpdate">
        </div>
        <button type="submit" class="btn btn-success mt-3">Proceed <i class="las la-arrow-alt-circle-right"></i></button>
        <button type="submit" class="btn btn-danger mt-3">Cancle <i class="las la-times-circle"></i></button>
      </form>
    </div>
  </main>
