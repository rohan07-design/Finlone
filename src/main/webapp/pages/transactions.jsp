...
<head>
  ...
  <script defer data-site="demos.creative-tim.com" src="js/nepcha-analytics.js"></script>
</head>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3 ">
        <nav aria-label="breadcrumb">
          <h4 class="font-weight-bolder mb-0">Transaction Details <i class="las la-credit-card"></i></h4>
        </nav>
