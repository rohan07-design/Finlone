...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h4 class="font-weight-bolder mb-0">Add Applicants  <i class="las la-user-plus"></i></h4>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            ...
            <div class="Searchbuttons">
              <button class="btn bg-gradient-primary mt-3 ms-3" type="submit">Search</button>
            </div>
          </div>
  ...
  <script defer
    ...
    data-cf-beacon='{"rayId":"7b4015c47d12f4a4","version":"2023.3.0","r":1,"b":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}'
    crossorigin="anonymous"></script>
</body>

<!-- Mirrored from demos.creative-tim.com/material-dashboard/pages/tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Apr 2023 06:07:43 GMT -->
