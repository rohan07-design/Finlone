    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3 ">
        <nav aria-label="breadcrumb">
          <h4 class="font-weight-bolder mb-0">Loan Details <i class="las la-coins"></i></h4>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <button class="btn btn-outline-primary btn-sm mb-0 me-3">Search <i class="las la-search"></i></button>
            </li>
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col"><span class="headingText">Name</span> <i class="las la-user"></i></th>
            <th scope="col"><span class="headingText">Contact No</span> <i class="las la-phone"></i></th>
            <th scope="col" class="city"><span class="headingText">Address</span> <i class="las la-map-marker"></i></th>
            <th scope="col" class="email"><span class="headingText">Email Address</span> <i class="las la-envelope"></i></th>
            <th scope="col"><span class="headingText">User</span> <i class="las la-user-circle"></i></th>
            <th scope="col"><span class="headingText">Requsted Amount</span> <i class="las la-rupee-sign"></i></th>
            <th scope="col" style=""><span class="headingText">Verify Documents</span> <i class="las la-question-circle"></i></th>
          </tr>
        </thead>
        <tbody>
