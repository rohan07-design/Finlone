        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb">
                    <h2 class="font-weight-bolder text-center" id="heading">Download Transactions
        ...
        <div id="container">
            <div class="row row-cols-2">
                ...
                <div class="col mt-5" id="submitData">
                    <div class="">
                        <div class="input-group date" id="datepicker">
                            <button class="btn bg-gradient-success">Get Transactions <i class="las la-chevron-circle-right"></i></button>
                        </div>
                    </div>
                </div>
            </div>
