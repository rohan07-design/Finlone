...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3 ">
        <nav aria-label="breadcrumb">
          <h4 class="font-weight-bolder mb-0">Wallet Amount Details<i class="las la-wallet"></i></h4>
        </nav>
    ...
    <div id="container">
        <h4>Fund is: </h4>
        <h2>1 Cr Ruppees Only</h2>
        <div class="buttonsOperations mt-5">
            <button class="btn bg-gradient-primary">View Transactions <i class="lar la-file"></i></button>
            <a href="addWalletFunds.html"><button class="btn bg-gradient-primary">Update Wallet Amount <i class="las la-money-bill-wave la-1x"></i></button></a>
        </div>
    </div>
  </main>
