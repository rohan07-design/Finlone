			...
			<div class="container-fluid py-1 px-3 ">
				<nav aria-label="breadcrumb">
					<h4 class="font-weight-bolder mb-0">
						Customer Details <i class="las la-user-friends"></i>
					</h4>
				</nav>
			...
			<table class="table">
				<thead>
					<tr>
						...
						<th scope="col">Order Id <i class="las la-map-marker"></i></th>
						<th scope="col">Email Address <i class="las la-envelope"></i></th>
						<th scope="col">User <i class="las la-user-circle"></i></th>
						<th scope="col">Amount Approved <i class="las la-rupee-sign"></i></th>
						<th scope="col" style="padding-left: 2rem;">Received Date<i
							class="las la-question-circle"></i></th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${cust }" var="e">
						<tr>
							...
							<td class="number">${e.mobNo }</td>
							<td class="city">${e.orderId }</td>
							<td class="email">${e.email }</td>
							<td class="typeOfApplicant">${e.typeOfApplicant }</td>
							<td class="amount">${e.amount }
							<td class="amount">${e.createdAtDate }
					</c:forEach>
					</tr>
				</tbody>
			</table>
			<div class="d-grid gap-2 col-3 mx-auto">
				<button class="btn btn-primary"><a href="/generatereport">Generate PDF Report</a></button>
			</div>
		</div>
	</main>
