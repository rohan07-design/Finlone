...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3 ">
        <nav aria-label="breadcrumb">
          <h4 class="font-weight-bolder mb-0">Collected Loans Details <i class="las la-rupee-sign"></i></h4>
        </nav>
    ...
    <div id="status" class="col-lg-3 mt-3">
        <select class="form-select" aria-label="Default select example">
            <option selected class="p-3">Daily</option>
            <option value="1" class="p-3">Monthly</option>
          </select>
    </div>
      ...
      <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col">Collected Amount <i class="las la-rupee-sign"></i></th>
                <th scope="col" style="padding-left:2rem;">Date <i class="las la-question-circle"></i></th>
              </tr>
        </thead>
        <tbody>
          <tr>
